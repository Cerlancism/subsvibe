...
def _translate_system(target: str) -> str:
    return (
        ...
        f"Your job: translate the complete thought visible in the current window into natural {target}. "
        ...
        f"Output only the {target} translation of the current window, no explanations."
    )
